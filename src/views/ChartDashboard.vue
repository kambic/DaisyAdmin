<template>
  <div class="min-h-screen bg-base-200 p-4 md:p-8">
    <div class="max-w-6xl mx-auto">
      ...
      <!-- Header -->
      <div class="mb-8">
        <h1 class="text-4xl font-bold text-primary mb-2">Vue Chart.js Samples</h1>
      ...
      <div class="mockup-code mt-6 bg-neutral text-neutral-content">
        ...
        <pre data-prefix="2"><code>import { ref, computed } from 'vue'</code></pre>
        <pre data-prefix="3"><code>import { Bar } from 'vue-chartjs'</code></pre>
        ...
        <pre data-prefix="9"><code>  &lt;Bar :data="chartData" /&gt;</code></pre>
      ...
      <div class="flex justify-center mt-6">
        <div class="dropdown dropdown-top">
          ...
          <ul tabindex="0" class="dropdown-content z-[1] p-2 shadow-2xl bg-base-300 rounded-box w-52 max-h-96 overflow-y-auto">
            <li v-for="theme in themes" :key="theme">
              <button class="btn btn-sm btn-block btn-ghost justify-start" @click="changeTheme(theme)">
                {{ theme }}
              </button>
            </li>
          </ul>
